...
local amount = vim.g.zenburn_dark_amount or 0.1
...
local c = {
  ...
  ["fg+1"] = "#FFFFEF",
  ["fg+2"] = "#FFFFFD",
  ["bg-2"] = util.darken("#000000", amount),
  ["bg-1"] = util.darken("#2B2B2B", amount),
  ["bg-08"] = util.darken("#303030", amount),
  ["bg-05"] = util.darken("#383838", amount),
  ["bg"] = util.darken("#3F3F3F", amount),
  ["bg+05"] = util.darken("#494949", amount),
  ["bg+1"] = util.darken("#4F4F4F", amount),
  ["bg+2"] = util.darken("#5F5F5F", amount),
  ["bg+3"] = util.darken("#6F6F6F", amount),
  ["red-6"] = "#6C3333",
  ["red-5"] = "#7C4343",
  ["red-4"] = "#8C5353",
  ["red-3"] = "#9C6363",
